Shader "example/Parallax"
{
	...
	Properties
	{
		...
		[NoScaleOffset]_DepthTex("Depth Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				half height = SAMPLE_TEXTURE2D(_DepthTex, sampler_DepthTex, uv).r;
			...
			half4 frag(VStoFS IN) : SV_Target
			{
				...
				half3 N_TS = UnpackNormal(SAMPLE_TEXTURE2D(_NormalTex, sampler_NormalTex, uv));
